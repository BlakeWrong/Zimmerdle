var app = (function () {
	...
	// use soundcloud_util.js for downloading new songs from a soundcloud album, paste in browser console
			...
			p(e, t) {
				e[1].img
					...
					2 & t &&
						d !==
							(d =
								'Listen to ' + e[1].artist + ' - ' + e[1].title + ' on SoundCloud') &&
						M(n, 'title', d);
			},
			d(e) {
				e && y(t), h && h.d(), f && f.d();
	...
	function pt(e, t, n, trackStartTime = 0) {
		...
		let r,
			...
			i,
			o,
			attemptIntervalAltArray,
			l,
			endOfAttemptIntervalList,
			currentAttemptIntervalIndex;

		const c = A();
		let { currentAttempt: d } = t,
			{ currentHeardle: h } = t,
			{ config: configObject } = t,
			{ trackDuration: m = 0 } = t,
			{ gameState: p } = t,
			g = !1;
		var y;
				...
				function () {
					y.getCurrentSound(function (e) {
						...
						y.bind(SC.Widget.Events.PLAY_PROGRESS, function (e) {
							(endOfAttemptIntervalList = attemptIntervalAltArray.slice(-1)[0]),
								n(11, (currentTime = e.currentPosition - trackStartTime)),
								1 == s
									? p.isPrime
										? (n(
												10,
												(percentage = (currentTime / currentAttemptIntervalIndex) * 100)
										  ),
										  currentTime > currentAttemptIntervalIndex && M())
										: (n(
												10,
												(percentage =
		...
		return (
			(e.$$set = (e) => {
				'currentAttempt' in e && n(0, (d = e.currentAttempt)),
					...
					'config' in e && n(2, (configObject = e.config)),
			...
			(e.$$.update = () => {
				16 & e.$$.dirty[0] && n(18, (r = p.musicIsPlaying)),
					...
					1 & e.$$.dirty[0] && n(7, (o = d)),
					4 & e.$$.dirty[0] &&
						n(8, (attemptIntervalAltArray = configObject.attemptIntervalAlt)),
					405 & e.$$.dirty[0] &&
						n(
							16,
							(l = p.isPrime
								? (attemptIntervalAltArray[o - 1] /
										attemptIntervalAltArray.slice(-1)[0]) *
								  100
								: (d / configObject.maxAttempts) * 100)
						),
					384 & e.$$.dirty[0] &&
						(currentAttemptIntervalIndex = attemptIntervalAltArray[o - 1]);
			}),
			[
				d,
				h,
				...
				var a = function (e) {
					...
					h = function (e, t, n) {
						...
						if (((t = t.toString()), (e = u(e, i)), 'loose' === s)) {
							...
							if (~f)
								return (
									(e = t.substring(f, f + e.length)), o ? t.replace(e, c(e, o)) : t
								);
						}
					},
					f = function (e, t) {
												  ...
												  e.resultsList &&
														(function (e) {
															var n = e.resultsList,
																...
																a = i.results;
															if (
																((e.cursor = -1), (r.innerHTML = ''), o.length || n.noResults)
															) {
	...
	function jt(e, t, n) {
		...
		return (
			P(async function () {
				(async function () {
					const e = await fetch('https://wjsn-heardle.glitch.me/supporters.json');
					return await e.json();
				})().then((e) => {
					n(0, (r = e.supporters));
				});
	...
	const Vt = {
			...
			attemptIntervalAlt: [2e3, 4e3, 7e3, 10e3, 16e3, 30e3],
			maxAttempts: 6,
	...
	function Qt(e) {
		...
		return (
			...
			(O = new Rt({})),
			{
				...
				i(e) {
					P ||
						(Z(d.$$.fragment, e), Z(S.$$.fragment, e), Z(O.$$.fragment, e), (P = !0));
				},
				o(e) {
	...
	function ln(e) {
		// Displays how many times you got it right in each interval category
		let t,
			n,
			r,
			s,
	...
	function un(t) {
		...
		return {
			c() {
				n = _("You didn't get today's " + HEARDLE_NAME + '. Better luck tomorrow!');
			},
			m(e, t) {
				g(e, n, t);
			},
	...
	function fn(e, t, n) {
		console.log(
			'welcome to ' + HEARDLE_NAME + ', day #',
			t.currentHeardle.id + 1
		);
		let { userGuesses: r } = t,
			{ currentHeardle: s } = t,
			{ config: i } = t,
		...
		return {
			...
			p(e, n) {
				...
				64 & n && $(o, e[6]),
					256 & n && $(h, e[8]),
					320 & n &&
						B !== (B = (e[6] > 0 ? ((e[8] / e[6]) * 100).toFixed(1) : 0) + '') &&
						$(D, B),
		...
		e.exports = (function () {
			...
			function cr(e, t) {
				F(e, 0, 0, function () {
					var e = this.utcOffset(),
						n = '+';
					return (
						e < 0 && ((e = -e), (n = '-')), n + N(~~(e / 60), 2) + t + N(~~e % 60, 2)
					);
				});
			}
			cr('Z', ':'),
			...
			function hr(e, t) {
				...
				return null === s
					...
					: 0 ===
					  (r =
							60 * (n = ((s[s.length - 1] || []) + '').match(dr) || ['-', 0, 0])[1] +
							ce(n[2]))
					? 0
					: '+' === n[0]
					? r
			...
			t.$on('guess', e[15]),
			{
				...
				p(e, r) {
					...
					256 & r[0] && (s.isPrime = e[8].isPrime),
						...
						!n &&
							128 & r[0] &&
							((n = !0), (s.guessInput = e[7]), (i = () => (n = !1)), W.push(i)),
						t.$set(s);
				},
				i(e) {
	...
	function En(e) {
		...
		// console.log('N => ', N); // show the game debug info
		(Y = new gt({
			props: N,
		})),
			e[21](Y),
			...
			c() {
				(t = w('meta')),
					...
					M(
						...
						'Guess the ' +
							HEARDLE_ARTIST +
							' song from the excerpt in as few tries as possible'
					),
	...
	function jn(e, t, n) {
		...
		null == localStorage.getItem('userStats')
			...
			void 0 === f &&
				((f = l), h.push(f), localStorage.setItem('userStats', JSON.stringify(h)));
		let g,
			y,
			v = f.guessList,
			w = {
