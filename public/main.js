    ...
    function Nt(t) {
      ...
      return {
        c() {
          (n = w("div")),
            (n.innerHTML =
              '<p class="mb-3">A clone of <a href="https://www.heardle.app/" title="Heardle">Heardle</a> for '+HEARDLE_ARTIST+' songs.</p><p class="mb-3">Each Zimmerdle is randomly chosen from a list of movie music on Soundcloud</p> \n\n<p class="mb-3">All copyright goes to the respective artists, companies, and other relevant parties.</p> \n\n\n\n <p class="mb-3"></p> \n\n<p class="mb-3"><p class="mb-3"><a href="https://glitch.com/edit/#!/'+HEARDLE_GLITCH_NAME+'">Make your own Heardle by remixing this one</a></p> \n\n\n\n <p class="mb-3"></p>  \n\n\n\n <p class="text-xs mb-3 text-custom-line">Songs from <a href="https://soundcloud.com">Soundcloud</a>\n and powered by <a href="https://glitch.com/">Glitch</a>. See the source code <a href="https://glitch.com/edit/#!/'+HEARDLE_GLITCH_NAME+'">here</a>.'),
            M(n, "class", "text");
        },
        m(e, t) {
          g(e, n, t);
